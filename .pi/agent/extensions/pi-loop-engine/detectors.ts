...
export const DEFAULT_DETECTORS: DetectorRule[] = [
  {
    ...
    match: {
      ...
      excludeCommandPattern:
        "^(grep|rg|find|cat|head|tail|less|more|wc|awk|sed|cut|sort|uniq|file|ls|tree|git|echo|pipe|true|false|date|whoami|pwd|env|printenv)",
    },
    category: "test",
  ...
  },
  {
    ...
    match: {
      ...
      excludeCommandPattern:
        "^(grep|rg|find|cat|head|tail|less|more|wc|awk|sed|cut|sort|uniq|file|ls|tree|git|echo)",
    },
    category: "runtime",
